...
import styles from './WorkplaceDocuments.module.scss';
import { IWorkplaceDocumentsProps } from './IWorkplaceDocumentsProps';
...
export interface IworkplaceDocumentState {
  columns: IColumn[];
  items: IDocument[];
...
export default class WorkplaceDocuments extends React.Component<IWorkplaceDocumentsProps, IworkplaceDocumentState> {
  private _selection: Selection;
  private _allItems: IDocument[];
  
  constructor(props:IWorkplaceDocumentsProps){
    super(props);
  ...
  public render(): React.ReactElement<IWorkplaceDocumentsProps> {
  ...
  public componentDidUpdate(previousProps: any, previousState: IworkplaceDocumentState) {
    if (previousState.isModalSelection !== this.state.isModalSelection && !this.state.isModalSelection) {
      this._selection.setAllSelected(false);
    }
  }

  private _onChangeCompactMode = (checked: boolean) => {
